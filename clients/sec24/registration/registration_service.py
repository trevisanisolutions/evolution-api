...
from clients.sec24.registration.user_formatter import UserFormatter
from clients.sec24.sec24_client import SEC24ApiClient

logger = logging.getLogger(__name__)


#  TODO: Utilizar os retornos Json de toll_handler
